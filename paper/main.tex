...
\subsection{Experiment 4b: LLM Empirical Validation of Representation Effects}
...
\begin{figure}[t]
    ...
    \caption{Experiment 4b: Measured $A_{ij}$ per handoff (left), task latency per format (center), and total cost breakdown (right) on a real 7-task Claude pipeline. Prose is fastest but exhibits higher $A_{ij}$ variance; structured JSON is most consistent.}
    \label{fig:exp4b}
\end{figure}
